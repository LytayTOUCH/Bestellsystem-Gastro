...
return [
    ...
    */
    ...
    'repository_types' => [
        'github' => [
            'type' => 'github',
            'repository_vendor' => env('SELF_UPDATER_REPO_VENDOR', 'CloudMaker97'),
            'repository_name' => env('SELF_UPDATER_REPO_NAME', 'Bestellsystem-Gastro'),
            'repository_url' => 'https://github.com/CloudMaker97/Bestellsystem-Gastro.git',
