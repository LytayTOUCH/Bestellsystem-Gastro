        ...
        <div class="col-md-12">
            <div class="card card-default">
                <div class="card-body">
                    ...
                    @if(count($tisch_bestellungen) == 0)
                        Keine offene Abrechnungen
                    @else
                        <?php
                        $summe = 0;
                        ?>
                                ...
                                @foreach($kunde->bestelltes as $bestellung)
                                    ...
                                    @foreach($bestellung->produkte as $produkt)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('Bestellungen.Produkt.Kostenlos', ['id'=>$produkt->id])}}"
                                                   class="text-muted">Kostenlos</a> | <a
                                                        href="{{route('Bestellungen.Produkt.Entfernen', ['id'=>$produkt->id])}}"
                                                        class="text-danger">Entfernen</a>
                                            </td>
                                        </tr>
                                    @endforeach
